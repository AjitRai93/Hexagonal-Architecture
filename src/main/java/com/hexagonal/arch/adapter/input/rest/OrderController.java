package com.hexagonal.arch.adapter.input.rest;

import com.hexagonal.arch.domain.dto.FoodOrder;
import com.hexagonal.arch.domain.port.input.PlaceOrderUsecase;
import com.hexagonal.arch.domain.port.input.TrackOrderUsecase;
